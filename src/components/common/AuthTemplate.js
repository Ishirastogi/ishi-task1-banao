    ...
    <>
      ...
      <section className="  pt-4">
        ...
        <div className=" d-none d-lg-block">
          ...
          <button className="btn btn-outline-dark d-flex  justify-content-between align-items-center -2 w-100 templet-button ">
            <img src={"/assets/google.svg"} alt="" />
            <span>Continue with Google</span>
            <span></span>
          </button>
          <button className="btn btn-outline-dark d-flex  justify-content-between align-items-center -2 w-100 templet-button mt-3 ">

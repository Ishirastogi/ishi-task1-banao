    ...
    <>
          ...
          <div className="row">
            <div className="col-lg-8">
              ...
              <div className=" pt-5 section-1">
                <img src={"/assets/section1.svg"} alt="" />
              </div>
            </div>
      ...
      <section className="container mx-auto">
        <div
          ...
          className="container border rounded-2 m-3 pb-3 pt-3   px-4 py-4"
        >
      ...
      <div className="container mx-auto">
        ...
        <div className=" section-1 mt-5">
          <img src={"/assets/section4.jpg"} alt="" />
        </div>
      </div>
      <Footer />
    </>
